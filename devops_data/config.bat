...
set EnginePath=I:\UE_Client\UE_5.1
set VersionSelector=F:\Epic Games\Launcher\Engine\Binaries\Win64\UnrealVersionSelector.exe
...
set COPYRIGHT_LINE=// Snake Game. Copyright Fozzy. All rights reserved
